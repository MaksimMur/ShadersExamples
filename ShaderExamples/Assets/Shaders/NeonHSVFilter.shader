Shader "Hidden/NeonHSVFilter"
{
     Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
        _Threshold("Bloov threshold", Range(0,1)) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                fixed3 s = sobel(i.uv);
                //1 нужно домножить наш исходный цвет текстуры на цвет собеля
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                return (saturation>_Threshold) ? fixed4(tex,0) : fixed4(0,0,0,1);
            }
